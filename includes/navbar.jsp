<%-- 
    Document   : navbar
    Created on : 11 feb 2025, 2:57:02 p.m.
    Author     : Jedi
--%>
...
<nav class="navbar navbar-expand-lg">
    <div class="container">
        <a class="navbar-brand" href="index.jsp">Venta de juegos</a>
        <a class="navbar-brand" href="index.jsp">Realizador por Oscar Escobedo</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                <li class="nav-item">
                    <a class="nav-link" href="formulario2.jsp">Formulario</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="https://store.steampowered.com">Mas juegos</a>
                </li>
                <li class="nav-item">
